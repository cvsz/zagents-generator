...
const CHECKS = {
  ...
  async catalogCount() {
    const catalogPath = join(ROOT, 'packages', 'create-agent-gemini', 'templates', 'catalog.json');
    const tsTestPath = join(ROOT, 'packages', 'create-agent-gemini', '__tests__', 'generated-templates.test.ts');
