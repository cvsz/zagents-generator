...
function packageJsonTmpl() {
  ...
  "dependencies": {
    "@zagents/kernel": "^0.1.0",
    "@zagents/host-{{host}}": "^0.1.0"
  },
  "devDependencies": {
    "@types/node": "^20.0.0",
    "typescript": "^5.4.0",
...
function pluginJsonTmpl(t) {
  const cats = ['agent-gemini', 'zagents-scaffold'];
  if (t.category) cats.push(t.category);
  if (t.domain) cats.push(t.domain);
  const tags = ['zagents', 'agent-gemini'];
  ...
  return JSON.stringify(
    {
      ...
      description: '{{description}}',
      author: {
        displayName: 'Generated by zagents',
        url: 'https://www.npmjs.com/package/zagents',
      },
      license: 'MIT',
...
This gemini uses [@zagents/kernel](https://www.npmjs.com/package/@zagents/kernel) — a Rust-compiled WASM module with a NAPI-RS native fallback — so the same code runs identically on every platform.
`;
}
