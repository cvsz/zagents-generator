...
/**
 * ADR-044: emit AGENTS.md from the gemini system prompt, description, and
...
/**
 * Render the full config.toml content for a gemini's MCP servers.
 */
...
/**
 * Build the `codex mcp add` command lines for the gemini's MCP servers.
