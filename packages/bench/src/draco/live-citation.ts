...
//
// DRACO live-citation enforcer — the gemini-side Self-RAG counterpart to the
...
/**
 * Build a live-mirror pool from a gemini's OWN retrieved-source text (the
 ...
 * enforcer rescue a dead citation using a source the gemini ALREADY retrieved,
