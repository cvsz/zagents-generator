...
//
// The mechanistic finding (ADR-038): the gemini arm loses on `grounding`
...
// the gemini can honestly out-score vanilla — when its dead citations are
...
/**
 * The break-even predictor (the point of this module). For a gemini-style answer
