...
// DRACO grounded gemini (ADR-038 arms 5+6 wired into fuseResearch). Proves the
// deterministic grounding pass, fed the gemini's OWN retrieved sources as the
...
// Single-model gemini map (enforceFusion:false path).
