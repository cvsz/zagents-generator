...
```bash
npx create-agent-gemini my-trader --template-package @zagents/vertical-code-review
```

Or programmatically:

```js
import pack from '@zagents/vertical-code-review';
...
Code Review carries risk. Past backtest performance does not predict future results. This pack ships defaults that minimize risk in paper mode — verify them yourself before going live. The author and the zagents-generator project are not responsible for any losses.
