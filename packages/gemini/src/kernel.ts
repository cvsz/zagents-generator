...
//
// The Gemini Kernel (ADR-047): owns the run lifecycle and drives the execution
// loop. The model proposes (workers produce outputs); the gemini decides
...
/** The gemini kernel. Construct once with the algorithm modules, then `run` goals. */
