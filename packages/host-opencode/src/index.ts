...
//     mcp.permissions — directly compatible with .gemini/mcp-policy.json's
...
/**
 * Map the gemini allow/deny posture (ADR-022) onto opencode's top-level
