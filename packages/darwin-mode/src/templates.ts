...
/** A one-line summary of the repository this gemini was generated for. */
...
/** The symbolic kinds of command the gemini may schedule. */
...
/** A record of one outcome the gemini might choose to remember. */
