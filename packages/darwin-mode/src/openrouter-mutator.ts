...
// gemini ever emits a compiled language — it fails to compile Rust/C++/C there).
...
export class OpenRouterMutator implements CodeGenerator {
  ...
  async generateMutation(input: {
    ...
    const sys =
      'You improve ONE file of an AI agent gemini. Output ONLY the full replacement file — no prose, no fences. ' +
