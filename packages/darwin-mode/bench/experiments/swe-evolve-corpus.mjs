...
//
// ADR-133 — the capstone: EVOLVE the gemini against a real cross-package SWE fitness. Unites
// all four pillars — evolutionary engine + SWE runner + multi-package corpus (ADR-132) +
// fitness function (ADR-130). A gemini genome {patchMode, maxAttempts, selectK} is scored by
...
const SPECS = [
  ...
  { id: 'create-agent-gemini__constraints', pkg: 'create-agent-gemini', suites: ['constraints'],
...
console.log(JSON.stringify({
  experiment: 'ADR-133 — evolve the gemini against a real cross-package SWE fitness',
