...
// the gemini's real contextBuilder selects among the 21 REAL src filenames; a
...
// The gemini's real contextBuilder (from a generated baseline) selects among the
