...
// tie-break) over 3 external packages. Closes the "evolve every axis" story: the gemini
...
const SPECS = [
  ...
  { id: 'create-agent-gemini', pkg: 'create-agent-gemini', suites: ['constraints'],
...
console.log(JSON.stringify({
  ...
  verdict: `evolution autonomously selected model '${modelChosen}' (winner ${elite.f.genome}, ${elite.f.resolved}/${elite.f.total}, $${elite.f.cost_usd}) — the gemini self-optimizes its own model, no hand-picking (cf. ADR-135 manual frontier)`,
}, null, 2));
