...
// corpus + gemini config across several OpenRouter models and report resolve-rate + cost,
...
// 3 external single-fault packages (cheap, both-mode-resolvable) — fixed gemini config so the
