...
Darwin Mode lets an agent **mutate its own gemini** (seven policy files), run the
mutated gemini against a benchmark, and promote measured, safe wins. A
...
Related ADRs:
[ADR-070](../../docs/adrs/ADR-070-darwin-mode-self-improving-gemini.md) (loop) ·
