...
/**
 * Generate Claude Code-shaped settings.json content for a gemini.
...
/**
 * ADR-044: emit CLAUDE.md from the gemini system prompt + description.
...
/**
 * Build the `claude mcp add` command lines for the gemini's MCP servers.
 * These run as post-install steps in the gemini's own init script.
 */
