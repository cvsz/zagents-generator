...
//
// Mustache-style {{var}} renderer + gemini-name validation. Ported verbatim
// (behaviour-for-behaviour) from packages/create-agent-gemini/src/renderer.ts
...
/**
 * Validate that a gemini name is npm-publishable. Mirrors npm's own rules
