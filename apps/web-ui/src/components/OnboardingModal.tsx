...
export type StartingPoint = 'repo' | 'gemini' | 'artifact' | 'verify';
...
const STEPS = [
  ...
  {
    icon: GitBranch,
    title: 'Tab 1 — Repo → Gemini',
    blurb: 'You already have a GitHub repo and want a gemini shaped to it.',
    bullets: [
  ...
  },
  {
    ...
    blurb:
      'You don\'t want a whole gemini — just a single SKILL.md folder you can drop into Claude desktop or claude.ai.',
    bullets: [
...
const START_CHOICES: StartChoice[] = [
  {
    ...
    blurb: 'I have a repo. Generate a gemini shaped to it.',
    icon: GitBranch,
  },
  {
    point: 'gemini',
  ...
  },
  {
    point: 'verify',
    label: 'Verify a .zip',
    blurb: 'Drag a downloaded gemini in to inspect it safely.',
    icon: ShieldCheck,
  },
];
