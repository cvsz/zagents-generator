...
async function main() {
  ...
  try {
    ...
    // Desktop — Repo → Gemini view.
    await desktop.getByRole('button', { name: 'Repo → Gemini' }).click();
    ...
    await desktop.waitForSelector('text=Verify a gemini');
    ...
    await mobile.waitForSelector('text=Generated gemini');
