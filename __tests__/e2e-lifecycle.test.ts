...
//
// Exercises every `gemini` subcommand against ONE scaffolded gemini
// in a single chain:
//
//   scaffold              (iter 4)
//      ↓
...
import { scaffold } from '../packages/create-agent-gemini/src/index.js';
import { doctor, verify } from '../packages/create-agent-gemini/src/subcommands.js';
import { validate } from '../packages/create-agent-gemini/src/validate.js';
import { mcpDispatch } from '../packages/create-agent-gemini/src/mcp-cmd.js';
import { sbomCmd } from '../packages/create-agent-gemini/src/sbom-cmd.js';
import { auditCmd } from '../packages/create-agent-gemini/src/audit-cmd.js';
import { upgradeCmd } from '../packages/create-agent-gemini/src/upgrade-cmd.js';
import { publishCmd } from '../packages/create-agent-gemini/src/publish-cmd.js';
import { federateDispatch } from '../packages/create-agent-gemini/src/federate.js';
import { diagCmd } from '../packages/create-agent-gemini/src/diag.js';
...
describe('e2e lifecycle: scaffold → all 13 subcommands (iter 52 + iter 66 diag)', () => {
  it('every subcommand survives the chain', async () => {
    ...
    try {
      ...
      // 10. federate init — creates .gemini/federation.json
