...
```
[step 1] Scaffold a "demo-bot" gemini from template="minimal" host="claude-code"
  output dir: C:\Users\…\Temp\ahg-quickstart-AbCdEf
  wrote 13 files, manifest at .gemini/manifest.json

[step 2] Validate the scaffolded output
  gemini validate — …\ahg-quickstart-AbCdEf
    PASS doctor     — …
...
This single script touches every layer the meta-gemini ships:
...
| `--name=<name>` | Override the generated gemini name. Default `demo-bot`. |
