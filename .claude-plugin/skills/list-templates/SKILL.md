---
name: list-templates
description: List the available gemini templates and what each one ships with. Use when the user asks "what templates are available", "what verticals does the gemini generator support", or "show me what I can scaffold".
---

# list-templates

Lists every gemini template `create-agent-gemini` can scaffold from.
...
| `eject-from-ruflo` | Iter 4 | — | — | — | Convert an existing ruflo install into your own gemini |
...
- See [ADR-013](https://github.com/ruvnet/agent-gemini-generator/blob/main/docs/adrs/ADR-013-vertical-packs-publishing.md)
