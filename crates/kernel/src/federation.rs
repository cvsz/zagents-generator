...
//
// Federation: multi-instance gemini coordination.
//
// Per ADR-014 (Self-evolution + federation), a gemini can talk to other
...
pub struct Peer {
    ...
    pub id: String,
    /// Human-readable name (matches the gemini's package name).
    pub name: String,
