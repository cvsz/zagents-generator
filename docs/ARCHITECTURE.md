...
│                                                                  │
│   create-agent-gemini (CLI)   examples/quickstart               │
│   gemini CLI subcommands       examples/federation              │
...
|---|---|---|---|
| `gemini validate <path> --skip-gcp` | Per-scaffolded-gemini | <1s | doctor + witness verify + path-guard + mcp + (optional) GCP secret check |
