...
This is the ADR-098 behaviour, demonstrated end-to-end at micro scale: *evolving the gemini measurably improves what a real model can solve, verified by real tests.* Combined with the earlier results it completes the chain —
