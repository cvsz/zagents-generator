...
## Result (official `swebench` Docker gemini, full 300, batch-verified)
...
`bench/swebench/predictions-hybrid-300.jsonl`. Reproducible via `solve-repair.mjs` + the official gemini.
