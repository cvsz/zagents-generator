...
Calibration gemini + result committed (`bench/experiments/fdr-calibration.mjs`, `bench/results/fdr-calibration.json`). Guard + doc caveats added. 349 tests unaffected (the BH unit tests use clearly-separated p-values, which remain correct).
