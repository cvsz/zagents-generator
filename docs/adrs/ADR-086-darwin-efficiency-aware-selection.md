...
- Real runs that opt in now converge toward the *most efficient* gemini among those that clear the gate — a meaningful, if secondary, fitness signal that the ceiling-bound scorer cannot express.
