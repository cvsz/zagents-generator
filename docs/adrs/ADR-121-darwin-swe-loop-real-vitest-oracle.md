...
Gemini + result committed (`bench/experiments/swe-realtests.mjs`, `bench/results/swe-realtests.json`); committed `src/pareto.ts` verified clean (experiment uses a temp copy with symlinked node_modules). 350 tests unaffected.
