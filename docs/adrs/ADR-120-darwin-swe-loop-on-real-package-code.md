...
Gemini + result committed (`bench/experiments/swe-realcode.mjs`, `bench/results/swe-realcode.json`); the committed `src/pareto.ts` is verified untouched (the experiment operates on a temp copy). 350 tests unaffected.
