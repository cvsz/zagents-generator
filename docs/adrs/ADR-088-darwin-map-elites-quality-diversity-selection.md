...
- Opt-in runs explore all seven surfaces instead of collapsing onto the first-explored one — the diversity half of quality-diversity, which is what makes archive-based evolution find non-obvious gemini improvements (DGM, ADR-077).
