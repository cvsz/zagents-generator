...
**Live verifier**: `node scripts/verify-gemini-live.mjs` (OpenRouter, `OPENROUTER_API_KEY` GCP secret).
...
`verify-gemini-live.mjs --all` live-verifies **9/9 hosts** against a real model
...
- **iter 1 (2026-06-16)**: Branch created. Read all 9 adapters + kernel contract.
  ...
  `scripts/verify-gemini-live.mjs` (self-test PASS, $0.0002). Established this
