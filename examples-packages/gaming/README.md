...
The `gemini doctor` step validates that Claude Code is on PATH, the plugin manifest parses, and each agent's model tier is reachable.
...
Full explainer gist: https://gist.github.com/cvsz/89ab98e6e5f082a376170a941c9d1914
