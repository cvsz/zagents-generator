...
- ruqu-mcp MCP server (ADR-008): https://github.com/ruvnet/agent-gemini-generator
- ADR-068 (this design): https://github.com/ruvnet/agent-gemini-generator/blob/main/docs/adrs/ADR-068-example-qiskit.md
