#!/usr/bin/env node
// @zagents/example-huggingface — one-command scaffold + bespoke agent bundle.
...
const PKG = '@zagents/example-huggingface';
...
console.log(`Wrote ${totalBundle} bespoke showcase file(s) per project (agents/, .gemini/mcp-policy.json, commands/, .env.example).`);
console.log('\nNext steps:');
